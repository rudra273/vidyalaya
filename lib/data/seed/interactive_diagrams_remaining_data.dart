...
const remainingInteractiveDiagrams = [
  InteractiveDiagram(
    ...
    description: DiagramText(
      en: 'Explore the major bones that support and protect the human body.',
      hi: 'मानव शरीर को सहारा और सुरक्षा देने वाली प्रमुख हड्डियों को जानें।',
      or: 'ମାନବ ଶରୀରକୁ ଆଧାର ଓ ସୁରକ୍ଷା ଦେଉଥିବା ପ୍ରମୁଖ ଅସ୍ଥିଗୁଡ଼ିକୁ ଜାଣନ୍ତୁ।',
    ),
    imagePath: 'assets/diagrams/interactive/human_skeleton.png',
    aspectRatio: 2 / 3,
    labels: [
      InteractiveDiagramLabel(
        id: 'skull',
        title: DiagramText(en: 'Skull', hi: 'खोपड़ी', or: 'କପାଳ'),
        explanation: DiagramText(
          en: 'Protects the brain and forms the framework of the face.',
          hi: 'मस्तिष्क की रक्षा करती है और चेहरे का ढाँचा बनाती है।',
          or: 'ମସ୍ତିଷ୍କକୁ ସୁରକ୍ଷା କରେ ଓ ମୁହଁର ଢାଞ୍ଚା ଗଠନ କରେ।',
        ),
        position: Offset(0.50, 0.08),
      ),
      InteractiveDiagramLabel(
        id: 'rib_cage',
        title: DiagramText(en: 'Rib cage', hi: 'पसली पिंजरा', or: 'ପଞ୍ଜରା'),
        explanation: DiagramText(
          en: 'Surrounds and protects the heart and lungs.',
          hi: 'हृदय और फेफड़ों को घेरकर उनकी रक्षा करता है।',
          or: 'ହୃଦୟ ଓ ଫୁସ୍‌ଫୁସ୍‌କୁ ଘେରି ସୁରକ୍ଷା କରେ।',
        ),
        position: Offset(0.50, 0.25),
      ),
      InteractiveDiagramLabel(
        id: 'spine',
        title: DiagramText(en: 'Spine', hi: 'रीढ़ की हड्डी', or: 'ମେରୁଦଣ୍ଡ'),
        explanation: DiagramText(
          en: 'A column of vertebrae that supports the body and protects the spinal cord.',
          hi: 'कशेरुकाओं का स्तंभ जो शरीर को सहारा देता और मेरुरज्जु की रक्षा करता है।',
          or: 'କଶେରୁକାର ସ୍ତମ୍ଭ ଯାହା ଶରୀରକୁ ଆଧାର ଦିଏ ଓ ସୁଷୁମ୍ନାକାଣ୍ଡକୁ ସୁରକ୍ଷା କରେ।',
        ),
        position: Offset(0.48, 0.37),
      ),
      InteractiveDiagramLabel(
        id: 'pelvis',
        title: DiagramText(en: 'Pelvis', hi: 'श्रोणि', or: 'ଶ୍ରୋଣୀ'),
        explanation: DiagramText(
          en: 'Connects the spine to the legs and supports organs in the lower abdomen.',
          hi: 'रीढ़ को पैरों से जोड़ती है और निचले उदर के अंगों को सहारा देती है।',
          or: 'ମେରୁଦଣ୍ଡକୁ ଗୋଡ଼ ସହ ଯୋଡ଼େ ଓ ତଳ ପେଟର ଅଙ୍ଗଗୁଡ଼ିକୁ ଆଧାର ଦିଏ।',
        ),
        position: Offset(0.50, 0.46),
      ),
      InteractiveDiagramLabel(
        id: 'femur',
        title: DiagramText(en: 'Femur', hi: 'जांघ की हड्डी', or: 'ଊରୁ ଅସ୍ଥି'),
        explanation: DiagramText(
          en: 'The thigh bone; it is the longest and strongest bone in the body.',
          hi: 'जांघ की हड्डी; यह शरीर की सबसे लंबी और मजबूत हड्डी है।',
          or: 'ଜଙ୍ଘର ଅସ୍ଥି; ଏହା ଶରୀରର ସବୁଠାରୁ ଲମ୍ବା ଓ ଶକ୍ତ ଅସ୍ଥି।',
        ),
        position: Offset(0.38, 0.62),
      ),
      InteractiveDiagramLabel(
        id: 'humerus',
        title: DiagramText(
          en: 'Humerus',
          hi: 'ऊपरी बाँह की हड्डी',
          or: 'ବାହୁ ଅସ୍ଥି',
        ),
        explanation: DiagramText(
          en: 'The long bone of the upper arm between the shoulder and elbow.',
          hi: 'कंधे और कोहनी के बीच ऊपरी बाँह की लंबी हड्डी।',
          or: 'କାନ୍ଧ ଓ କହୁଣି ମଧ୍ୟରେ ଥିବା ବାହୁର ଲମ୍ବା ଅସ୍ଥି।',
        ),
        position: Offset(0.72, 0.35),
      ),
    ],
  ),
  InteractiveDiagram(
