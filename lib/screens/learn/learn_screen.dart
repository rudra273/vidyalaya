            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  // Row 1b: AI Tutor (coming soon)
                  GestureDetector(
                    onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('AI Tutor is coming soon!'),
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Icon(Icons.school_rounded, color: cs.tertiary),
                          ),
                          const SizedBox(width: 16),
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  'Guided, step-by-step tutoring for each subject',
                                  style: Theme.of(context).textTheme.bodySmall
                                      ?.copyWith(color: AppColors.textMuted),
                                ),
                              ],
                  ...
                  // Row 6: Cosmulator
                  GestureDetector(
                    onTap: () => context.push('/learn/cosmulator'),
                    child: Container(
                      margin: const EdgeInsets.only(bottom: 16),
                      padding: const EdgeInsets.all(20),
                      decoration: BoxDecoration(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  'Explore the solar system and galaxy in 3D',
                                  style: Theme.of(context).textTheme.bodySmall
                                      ?.copyWith(color: AppColors.textMuted),
                                ),
                              ],
