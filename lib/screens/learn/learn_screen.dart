                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.science, color: Colors.purpleAccent),
                          ),
                          const SizedBox(width: 16),
                          Expanded(
                            child: Column(
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Icon(Icons.schema, color: Colors.teal.shade700),
                          ),
                          const SizedBox(width: 16),
                          Expanded(
                            child: Column(
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: Icon(Icons.history_edu, color: Colors.amber.shade700),
                          ),
                          const SizedBox(width: 16),
                          Expanded(
                            child: Column(
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.quiz, color: Colors.pinkAccent),
                            ),
                            const SizedBox(width: 16),
                            Expanded(
                              child: Text(
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Icon(Icons.biotech, color: Colors.lightGreen.shade700),
                            ),
                            const SizedBox(width: 16),
                            Expanded(
                              child: Text(
