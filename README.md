...
create book mark page scrren -  section where user can see all book marks per subject same like notes.. add in home sccren replace the my books becaosue alredy have in navbar. - book mark featuere is laredy there just need a spcifc page to see all the bookmakrs..

crate downloads section in profile where user can downlode or delete the books..

create a section called timetable in home screen where user can see the timetable for all subjects.. this user have crate and update by themsevelve like updateing skool time table per class.. replace the sylabys card with this..  